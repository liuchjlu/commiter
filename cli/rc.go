...
func Rc(app, component, containerip, containername, image, etcdpath string) {
	...
	BuildDownload(app, component, containername)
	BUildUpload(app, component, containerip, containername)
...
//create download.sh
func BuildDownload(app, component, containername string) {
...
//create upload.sh
func BUildUpload(app, component, containerip, containername string) {
	filepath := "/etc/.commiter/sh/"
	os.MkdirAll(filepath, 0755)
